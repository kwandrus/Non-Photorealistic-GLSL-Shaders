...
int main(int argc, char** argv)
{
	...
	// tell OpenGL how the vertex data should be interpreted and where the data comes from (the currently bound buffer - VBO)
	// position attribute
	...
	// but updating a uniform does require you to first use the program
	/*ourShader.use();
	float offset = 0.5f;
